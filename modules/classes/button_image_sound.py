...
class ButtonImageSound(Widget):
    ...
    def __init__(self, x: int, y: int, dimension_scale: tuple, text: str, screen: pg.Surface, image_path: str, sound_path: str, align: str = 'center', font_size = 25, on_click = None, on_click_param = None) -> None:
        """
